...
| **番外2** | 《比武大会》原创 NES 游戏(6502 汇编,`game/tourney/`) | 标题/演示冒烟测试 | ✅ 完成(Punch-Out 式马上长枪对决:B 盾 A 固枪三线、固枪时机窗口、看破早枪/假盾 AI;荣誉系统即规则:致意/断盾留情/扶起对手/低刺失德/击马犯规判负,荣誉定平局裁决、决赛再战与三结局;战役七将+2P 对战+教学卡 AI 演示循环) |
